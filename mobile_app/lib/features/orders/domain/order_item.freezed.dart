...
mixin _$OrderItem {
  ...
  double get perUnitPrice => throw _privateConstructorUsedError;
...
class _$OrderItemImpl implements _OrderItem {
  ...
  @override
  String toString() {
    return 'OrderItem(id: $id, productId: $productId, quantity: $quantity, perUnitPrice: $perUnitPrice, totalPrice: $totalPrice)';
  }
...
abstract class _OrderItem implements OrderItem {
  const factory _OrderItem({
    ...
    required final double perUnitPrice,
